    ...
    def difMOD [A](x: Int, l1: List[A], l2: List[A]): List[Int] =
      {
        ...
        else if l1 == Nil then x :: difMOD(x + 1, l1, l2.tail)
        else if l2 == Nil then x :: difMOD(x + 1, l1.tail, l2)
        else if l1.head == l2.head then difMOD(x + 1, l1.tail, l2.tail)
        else x :: difMOD(x + 1, l1.tail, l2.tail)
      }
    difMOD(0, l1, l2)
  }
